    ...
    return(
        <div className="container relative  mx-auto my-4 h-fit font-serif">
            ...
            <div className="grid md:grid-cols-2">
                ...
                <div className='col-span-1  py-4 mx-8'>
                    ...
                    <div className="flex ">
                        ...
                        <button className="border border-primary bg-primary flex-grow text-white p-4 w-1/2 flex justify-center text-xl ">
                            Add To Card
                        </button>
                        <button className="border border-gray-400 p-4 w-fit mx-4 flex justify-center ">
                            <MdOutlineFavoriteBorder className='text-2xl'/>
                        </button>
                    </div>
                    <button className="my-8 mx-4 border border-primary bg-white flex-grow text-gray-900 p-4 w-full flex justify-center text-xl ">
                           Buy Now
                    </button>
           ...
           <div className="flex justify-center w-full">
                <div className="text-center my-4 w-2/3">
           ...
           </div>
           {
            overlay&&<div onClick={()=>setOverlay(false)} className='fixed opacity-90 w-screen z-30 h-screen top-0 left-0 flex justify-center items-center bg-stone-400'>
                <div className="bg-white w-1/2 h-fit p-8 ">
